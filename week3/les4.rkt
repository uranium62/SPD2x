...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname les4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(define-struct node (key val l r))
;; BST (Binary Search Tree) is one of:
;; - false
;; - (make-node Integer String BST BST)
;; interp false mens no BST, or empty
;;        key is the node key
;;        val is the node val
...
;; Try to find node with given key, if find -> val, if not -> false
